...
function firebugFrameLoad(Firebug)
{
    ...
    // * ITDCDebugger; is unique prefix of all messages that should be customized.
    // * DBG_ITDCDEBUGGER is a class name with style defined in the specified stylesheet.
    Firebug.registerTracePrefix("ITDCDebugger;", "DBG_ITDCDEBUGGER", true,
        "chrome://itdcdebugger/skin/trace.css");
    ...
    var config = {id: "ITDCDebugger@long.ge"};
    Firebug.registerExtension("ITDCDebugger", config);
}
...
function firebugFrameUnload(Firebug)
{
    ...
    Firebug.unregisterExtension("ITDCDebugger");
    Firebug.unregisterTracePrefix("ITDCDebugger;");
}
